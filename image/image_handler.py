...
def main_menu_image():
    main_image = pygame.image.load("image/backgrounds_src/BG10.jpg")
...
def credits_image():
    credits_image = pygame.image.load("image/backgrounds_src/credits_bg3.jpg")
...
def get_roadkill_sprite(drunk_meter):
    dead_frogs = ["dead_Hasse.png", "dead_Hasse.png", "dead_Hasse.png", "dead_Hasse.png",
                  "dead_Hasse.png"]
