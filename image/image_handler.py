...
def get_player_sprite(drunk_meter):
    ...
    player_sprite = pygame.image.load(f"image/backgrounds_src/{player_sprites[drunk_meter]}").convert_alpha()
...
def get_get_sprite():
    get_sprite = pygame.image.load("image/backgrounds_src/visgetens_het.png")
    get_sprite = pygame.transform.scale(get_sprite, (100, 85))
    return get_sprite


def get_background_image():
    background_image = pygame.image.load("image/backgrounds_src/back_placehold2.png")
...
def get_mob_sprite(is_left):
    ...
    mob_sprite = pygame.image.load(f"image/backgrounds_src/{choice(cars_sprites)}").convert_alpha()
...
def get_life_sprite():
    life_sprite = pygame.image.load("image/backgrounds_src/frog_face.png")
...
def get_dead_sprite(drunk_meter):
    ...
    dead_frog = pygame.image.load(f"image/backgrounds_src/{dead_frogs[drunk_meter]}")
